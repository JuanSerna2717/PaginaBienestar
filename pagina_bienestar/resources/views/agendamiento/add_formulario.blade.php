...
<body>
    ...
    <main>
        ...
        <div class="container">
            <h2>Formulario Participación {{ $servicios->title }}</h2>
            <h3>Descripción</h3>
                <label for="">{{ $servicios->description }}</label>
            <div>
                <img src="products/{{ $servicios->image }}" alt="">
            </div>
            ...
            <dialog id="formulario">
                ...
                <form action="{{url('upload_formulario_servicios')}}" method="Post" enctype="multipart/form-data" >
                    @csrf
