...
<body>
    <div class="principal">
        ...
        <div class="logoSena"><img src="../img/logoSena.png" alt=""></div>
        <h2>Bienvenido/a</h2>
        <div class="login">
            <div class="datos"> 
                <form method="POST" action="{{ route('register') }}">
                    @csrf
                    <div class="textoLogin"><h3>Registro</h3></div>
                    ...
                    <div class="forgot-passaword">
                        <input type="submit" value="Enviar" class="boton-ingresar">
                        <a href="{{ route('login') }}" class="boton-crear-cuenta">Iniciar Sesión</a>
                    </div>
                </form>
            </div>
        </div>
