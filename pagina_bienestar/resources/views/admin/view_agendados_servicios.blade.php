                    ...
                    <tbody>
                        @foreach($agendados as $agendado)
                            <tr>
                                ...
                                <td data-label="Servicio">{{ $agendado->servicio }}</td>
                                ...
                                <td data-label="Editar" class="action-buttons">
                                    <a class="btn btn-success" href="{{url('aprobada_',$agendado->id)}}">Aprobar</a>
                                </td>
                                <td data-label="Rechazar" class="action-buttons">
                                    <a class="btn btn-danger" href="{{url('rechazada_',$agendado->id)}}">Rechazar</a>
                                </td>
                                <td>
                                    <a class="btn btn-danger" onclick="confirmation(event)" href="{{ url('delete_usuario_', $agendado->id) }}">Eliminar</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
